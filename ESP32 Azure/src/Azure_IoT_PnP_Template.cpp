...
// Modified to fit DOIT ESP32 Devkit v1 by https://github.com/microsoft/azure-iot-central-esp32-sample
// Removed all OLED realted code as the DOIT ESP32 has no such display
// Removed esp32_azureiotkit_initialize_sensors()


// Telemetry properties has been modifed to fit needs of our speaker project

// Added for analog read //
#include <Arduino.h>
///////////////////////////
#include <stdlib.h>
#include <stdarg.h>
